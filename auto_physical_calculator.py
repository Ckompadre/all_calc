...
answer = [[''],                                                         #0
          ...
          ['Oбъем конфузора = ' , ''],                      #44
          ['Длина цилиндрической части = ' , ''],           #45
          ['Радиус сопряжения R1 = ' , ''],                 #46
          ['Радиус сопряжения R2 = ' , ''],                 #47
          ['Длина конфузора' , '']]                         #48
...
def CombustionChamber():
    ...
    print("Геометрическая степень расширения сопла = ", F_c)
    ...
    q0c = float(input("Коэффициент потерь в закритической части канала на земле(временно) = "))
    ...
    delta_qc = answer[24][1] = (Fc / 0.1013) / (P00 * 10**6)
    ...
    q0c = answer[25][1] = q00c * ((1 - (delta_qc / q00c)) / (1 - delta_qc))
    ...
    '''
    print("\nOбъем конфузора")
    r_Vkonf = answer[44][1] = r_Fkp * r_lvh * (((2 * r__Fk + r__y**2) * (r_H / (3 * r_lvh))) + ((r__y**2 + r__y + 4) * (r_h / (6 * r_lvh))))
    print("Oбъем конфузора = ", r_Vkonf)
    '''
    
    print("\nДлина цилиндрической части")
    r_lc = answer[45][1] = r_Vk / r_Fk
